        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Button size="lg" className="bg-orange-600 text-white hover:bg-gray-50 hover:text-orange-700 shadow-lg">
                <Heart className="w-5 h-5 mr-2" />
                Get Small Pet Advice
              </Button>
              <Button size="lg" className="bg-white/20 backdrop-blur-sm border border-white/30 text-white hover:bg-white hover:text-orange-600 shadow-lg">
            ...
            <Card className="bg-gradient-to-r from-orange-600 to-yellow-600 text-white">
              <CardContent className="p-8 text-center">
                ...
                <Link to="/">
                  <Button 
                    size="lg" 
                    className="bg-orange-600 text-white hover:bg-gray-50 hover:text-orange-700 shadow-lg hover:shadow-xl transition-all duration-200 font-semibold text-sm sm:text-base break-words hyphens-auto px-4 py-3 min-h-12"
                    style={{
                      wordWrap: 'break-word',
                  ...
                  >
                    ...
                    <span className="flex-1">Ask About Your Small Pet - Free</span>
